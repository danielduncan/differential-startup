...
IF "%BatteryStatus%" EQU "2" (
	...
	start /min "" "C:\Program Files\Logitech Gaming Software\LCore.exe"
	...
	start /min "" "C:\Program Files (x86)\Razer\Synapse3\WPFUI\Framework\Razer Synapse 3 Host\Razer Synapse 3.exe"
)
